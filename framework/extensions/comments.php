...
if (!class_exists('inti_comments')) :
class inti_comments extends Walker_Comment{
    ...
    function __construct() { ?>
        ...
        <h3><?php comments_number(__('No Responses to', 'inti'), __('One Response to', 'inti'), __('% Responses to', 'inti') ); ?> &#8220;<?php the_title(); ?>&#8221;</h3>

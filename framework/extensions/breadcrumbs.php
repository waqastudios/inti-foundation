 ...
 */
function inti_get_breadcrumbs( $args = array() ) {
...
class Breadcrumb_Trail {
	...
	public function trail() {
		...
		if ( 0 < $item_count ) {
			...
			$breadcrumb .= '<ul class="trail-items breadcrumbs" itemscope itemtype="http://schema.org/BreadcrumbList">';
			// Add 'browse' label if it should be shown.
			if ( true === $this->args['show_browse'] )
				$breadcrumb .= sprintf( '<li class="show-for-sr"><span class="trail-browse">%s</span></li>', $this->labels['browse'] );
